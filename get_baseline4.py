...
def extract_ipd_ratio_all_chunk(file_path, chunksize=10000):
    ...
    chunk_iter = pd.read_csv(file_path, chunksize=chunksize,nrows=10000000)
...
def count_kmer(contig_forward_dict_dict, seq, strand = 1):
    ...
    for contig in contig_forward_dict_dict:
        ...
        kmer_baseline_dict, kmer_num_dict, save_kmer = prepare_data(seq, observed_IPD_list, kmer_baseline_dict, kmer_num_dict, 7, 3)
...
if __name__ == "__main__":   
    ...
    ref = "/home/shuaiw/methylation/data/borg/contigs/break_contigs.fasta"
    csv = "/home/shuaiw/methylation/data/borg/break_contigs/break_contigs.csv"
    test_csv = "/home/shuaiw/methylation/data/borg/human/test_result7_3.csv"
