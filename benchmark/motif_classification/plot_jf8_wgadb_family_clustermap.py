...
df = pd.read_csv(os.path.join(DATADIR, "jf8_wgadb_family_matrix.csv"), index_col=0)
...
bp = pd.read_csv(os.path.join(DATADIR, "jf8_wgadb_boldpos.csv"))
...
g.savefig(os.path.join(FIGDIR, "jf8_wgadb_family_clustermap.pdf"), bbox_inches="tight")
g.savefig(os.path.join(FIGDIR, "jf8_wgadb_family_clustermap.png"), dpi=200, bbox_inches="tight")
df.to_csv(os.path.join(FIGDIR, "jf8_wgadb_family_clustermap_sourcedata.csv"))
print("wrote", os.path.join(FIGDIR, "jf8_wgadb_family_clustermap.png"))
