...
KDEF = [("1", "bg_300"), ("2", "bg300_k2"), ("3", "bg300_k3"),
        ("4", "bg300_k4"), ("all", "bg300_kall")]
...
def strain_counts(base):
    m = pd.read_csv(f"{ROOT}/{base}/{base}.manifest.csv")
...
def main():
    ...
    fig.suptitle(f"C2: strain-mixture ECE-host assignment (58 donor species + 242 background; "
