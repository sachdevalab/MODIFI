...
# datafile = "/home/shuaiw/borg/allison/NANO_2_INF1330004_4G1/motif_profile.csv"
# bin_file = "/home/shuaiw/borg/allison/annotation/NANO_2_INF1330004_4PB_HR_HIFIASM_META.scaffolds_to_bin.txt"
# pdf = "/home/shuaiw/borg/allison/annotation/NANO_2_INF1330004_4PB_HR_HIFIASM_META.scaffolds_to_bin.pdf"


# datafile = "/home/shuaiw/borg/allison/NANO_2_INF1330004_4G1_NM3/motif_profile.csv"
# bin_file = "/home/shuaiw/borg/allison/annotation/NANO_2_INF1330004_4PB_HR_HIFIASM_META.scaffolds_to_bin.txt"
# pdf = "/home/shuaiw/borg/allison/annotation/NANO_2_INF1330004_4PB_HR_HIFIASM_META.scaffolds_to_bin_NM3.pdf"

# datafile = "/home/shuaiw/borg/allison/NANO_2_INF1340011_4G1/motif_profile.csv"
# bin_file = "/home/shuaiw/borg/allison/annotation/NANO_2_INF1340011_4PB_HR_HIFIASM_META.scaffolds_to_bin.txt"
# pdf = "/home/shuaiw/borg/allison/annotation/NANO_2_INF1340011_4PB_HR_HIFIASM_META.scaffolds_to_bin.pdf"

datafile = "/home/shuaiw/borg/allison/NANO_2_INF1340011_4G1_NM3/motif_profile.csv"
bin_file = "/home/shuaiw/borg/allison/annotation/NANO_2_INF1340011_4PB_HR_HIFIASM_META.scaffolds_to_bin.txt"
pdf = "/home/shuaiw/borg/allison/annotation/NANO_2_INF1340011_4PB_HR_HIFIASM_META.scaffolds_to_bin_NM3.pdf"
...
with open(bin_file) as f:
    for line in f:
        ...
        contig = field[0]
        bin_name = field[1]
        annotation = field[2].strip()
        if annotation != '':
            new_name = contig.split("_")[-2] + "_" + contig.split("_")[-1] + "_" + bin_name + "_" + annotation
        else:
            new_name = contig.split("_")[-2] + "_" + contig.split("_")[-1] + "_" + bin_name
        bin_name_dcit[contig] = new_name

df.index = [bin_name_dcit[contig] for contig in df.index]
print (df)
